/** Simple inline SVG icons (Heroicons-style) */
...
export function SquareFormatIcon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
...
export function StoryFormatIcon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
...
export function DocumentTextIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
